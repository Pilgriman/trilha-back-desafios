package trilha.back.financysdesafio08.controllers;
...
import trilha.back.financysdesafio08.dto.EntryDTO;
import trilha.back.financysdesafio08.exceptions.EntryAlreadyRegisteredException;
import trilha.back.financysdesafio08.service.EntryService;
...
public class EntryController {
    ...
    public ResponseEntity<?>calculateTheAverage(@RequestBody @PathVariable("x") Integer x, @PathVariable("y") Integer y ){
        return new ResponseEntity<>(" The result of the division is " +  entryService.calculateTheAverage(x, y)  ,HttpStatus.OK);
