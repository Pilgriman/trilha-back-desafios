...
import trilha.back.financysdesafio08.exceptions.CalculateException;
import trilha.back.financysdesafio08.exceptions.EntryAlreadyRegisteredException;
import trilha.back.financysdesafio08.exceptions.EntryNotFoundException;
import trilha.back.financysdesafio08.mapper.CategoryMapper;
import trilha.back.financysdesafio08.mapper.EntryMapper;
import trilha.back.financysdesafio08.repositories.CategoryRepository;
import trilha.back.financysdesafio08.repositories.EntryRepository;
...
//        entry.setAmount(entryDTO.getAmount());
    ...
    public Integer calculateTheAverage(Integer x , Integer y){
        try {
